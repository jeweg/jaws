/*
    ...
    GLX loader generated by glad 0.1.29 on Wed Apr 24 14:49:21 2019.
...
static int has_ext(const char* ext)
{
    ...
    if (!GLAD_GLX_VERSION_1_1) return 0;
...
static void load_GLX_AMD_gpu_association(GLADloadproc load)
{
    ...
    glad_glXCreateAssociatedContextAttribsAMD =
        (PFNGLXCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC)load("glXCreateAssociatedContextAttribsAMD");
    ...
    glad_glXMakeAssociatedContextCurrentAMD =
        (PFNGLXMAKEASSOCIATEDCONTEXTCURRENTAMDPROC)load("glXMakeAssociatedContextCurrentAMD");
    glad_glXGetCurrentAssociatedContextAMD =
        (PFNGLXGETCURRENTASSOCIATEDCONTEXTAMDPROC)load("glXGetCurrentAssociatedContextAMD");
...
static void load_GLX_MESA_query_renderer(GLADloadproc load)
{
    ...
    glad_glXQueryCurrentRendererStringMESA =
        (PFNGLXQUERYCURRENTRENDERERSTRINGMESAPROC)load("glXQueryCurrentRendererStringMESA");
...
static void load_GLX_NV_video_capture(GLADloadproc load)
{
    ...
    glad_glXEnumerateVideoCaptureDevicesNV =
        (PFNGLXENUMERATEVIDEOCAPTUREDEVICESNVPROC)load("glXEnumerateVideoCaptureDevicesNV");
...
static void load_GLX_SGIX_fbconfig(GLADloadproc load)
{
    ...
    glad_glXCreateGLXPixmapWithConfigSGIX =
        (PFNGLXCREATEGLXPIXMAPWITHCONFIGSGIXPROC)load("glXCreateGLXPixmapWithConfigSGIX");
...
static void load_GLX_SGIX_hyperpipe(GLADloadproc load)
{
    ...
    glad_glXQueryHyperpipeBestAttribSGIX =
        (PFNGLXQUERYHYPERPIPEBESTATTRIBSGIXPROC)load("glXQueryHyperpipeBestAttribSGIX");
