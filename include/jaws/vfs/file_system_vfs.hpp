...
public:
    ...
    bool get_file_contents(const Path&, std::vector<uint8_t>* out_contents, size_t offset_bytes, size_t num_bytes) const override;

private:

    bool get_file_contents(const std::filesystem::path& p, std::vector<uint8_t>* out_contents, size_t offset_bytes, size_t num_bytes) const;
